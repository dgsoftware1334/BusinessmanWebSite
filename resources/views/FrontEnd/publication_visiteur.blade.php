                ...
                <div class="container container-1310">
                    <div class="page-header-content-inner">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="{{url('/')}}">{{trans('about_trans.Home')}}</a></li>
      ...
      <div class="container container-1310">
        <div class="main-blog row">
         ...
         <textarea name="contenu" rows="8" id="message" placeholder="{{trans('about_trans.Your comment')}}" required ></textarea>
           ...
           <a  class="button  btn-lg btn-block"  style="background-color: #fd3d6b" href="{{url('user/login')}}" style="color: white;">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;{{trans('about_trans.Comment')}}</a>
