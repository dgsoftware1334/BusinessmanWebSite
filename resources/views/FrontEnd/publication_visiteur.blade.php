      ...
      <div class="container container-1310">
        <div class="main-blog row">
         ...
         <textarea name="contenu" rows="8" id="message" placeholder="Your Message" required ></textarea>
           ...
           <a  class="button  btn-lg btn-block"  style="background-color: #fd3d6b" href="{{url('user/login')}}" style="color: white;">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;confirmer</a>
