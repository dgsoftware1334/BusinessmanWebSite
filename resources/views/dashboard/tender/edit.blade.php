          ...
          <div class="card-body">
            <div class="row">
               ...
               @if (Session::get('success'))
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="intitule" placeholder="Intitule de l'appel d'offre" value="{{$tender->getTranslation('intitule', 'fr')}}" class="@error('intitule') is-invalid @enderror" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="intitule_ar" placeholder="Intitule de l'appel d'offre" value="{{$tender->getTranslation('intitule', 'ar')}}" class="@error('intitule') is-invalid @enderror" required>
                      <span class="text-danger">@error('intitule'){{ $message }} @enderror</span>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text"class="form-control" name="societe" placeholder="la sociéte qui lance l'appel d'offre" value="{{$tender->getTranslation('societe', 'fr')}}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text"class="form-control" name="societe_ar" placeholder="la sociéte qui lance l'appel d'offre" value="{{$tender->getTranslation('societe', 'ar')}}">
                     <span class="text-danger">@error('societe'){{ $message }} @enderror</span>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text"class="form-control" name="adresse" placeholder="l'adresse de l'entreprise" value="{{$tender->getTranslation('adresse', 'fr')}}">
                  ...
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label" >Adresse <span style="color:red">*</span></label>
                    <div class="col-sm-9">
                      <input type="text"class="form-control" name="adresse_ar" placeholder="l'adresse de l'entreprise" value="{{$tender->getTranslation('adresse', 'ar')}}">
                     <span class="text-danger">@error('adresse'){{ $message }} @enderror</span>
                    </div>
                  </div>
                     <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                       <textarea class="form-control" name="description" placeholder="{{trans('register_trans.Description')}}"> {{$tender->getTranslation('description', 'fr')}}</textarea>
                  ...
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label" >Description<span style="color:red">*</span></label>
                    <div class="col-sm-9">
                       <textarea class="form-control" name="description_ar" placeholder="{{trans('register_trans.Description')}}"> {{$tender->getTranslation('description', 'ar')}}</textarea>
                          <span class="text-danger">@error('phone'){{ $message }} @enderror</span>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label" >Description<span style="color:red">*</span></label>
                    <div class="col-sm-9">
                       <textarea class="form-control" name="description_aen" placeholder="{{trans('register_trans.Description')}}"> {{$tender->getTranslation('description', 'en')}}</textarea>
                          <span class="text-danger">@error('phone'){{ $message }} @enderror</span>
                    </div>
                  </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                   ...
                   <select name="type" class="form-control">
                       ...
                       @if($tender->type=="national ouvert")
                       <option value="national ouvert" selected> Appel d'offre national ouvert </option>
                       <option value="national restreint"> Appel d'offre national restreint </option>
                       <option value="international ouvert"> Appel d'offre international ouvert </option>
                       <option value="international restreint"> Appel d'offre international restreint </option>
                       @endif
                       @if($tender->type=="national restreint")
                       <option value="national restreint" selected> Appel d'offre national restreint </option>
                       <option value="national ouvert"> Appel d'offre national ouvert </option>
                       <option value="international ouvert"> Appel d'offre international ouvert </option>
                       <option value="international restreint"> Appel d'offre international restreint </option>
                       @endif
                       @if($tender->type=="international ouvert")
                       <option value="international ouvert" selected> Appel d'offre international ouvert </option>
                       <option value="national restreint" > Appel d'offre national restreint </option>
                       <option value="national ouvert" > Appel d'offre national ouvert </option>
                       <option value="international restreint"> Appel d'offre international restreint </option>
                       @endif
                       @if($tender->type=="international restreint")
                       <option value="international restreint" selected> Appel d'offre international restreint </option>
                       <option value="national restreint" > Appel d'offre national restreint </option>
                       <option value="national ouvert"> Appel d'offre national ouvert </option>
                       <option value="international ouvert"> Appel d'offre international ouvert </option>
                       @endif
                  ...
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label" >Type (ar)</label>
                    <div class="col-sm-9">
                   <select name="type_en" class="form-control">
                       <option value=""> -- Choisir --</option>
                       @if($tender->getTranslation('type', 'en')=="National open")
                       <option value="National open" selected> National open </option>
                       ...
                       @endif
                       @if($tender->getTranslation('type', 'en')=="Restricted National")
                       <option value="National open" > National open </option>
                       <option value="Restricted National" selected> Restricted National </option>
                       <option value="International open"> International open </option>
                       <option value="International restricted"> International restricted </option>
                       @endif
                       @if($tender->getTranslation('type', 'en')=="International open")
                       <option value="National open" > National open </option>
                       <option value="Restricted National" > Restricted National </option>
                       <option value="International open" selected> International open </option>
                       <option value="International restricted"> International restricted </option>
                       @endif
                       @if($tender->getTranslation('type', 'en')=="International restricted")
                       <option value="National open" > National open </option>
                       <option value="Restricted National" > Restricted National </option>
                       <option value="International open" > International open </option>
                       <option value="International restricted" selected> International restricted </option>
                       @endif
                  ...
                  <div class="form-group row">
                   ...
                   <select name="type_ar" class="form-control">
                       <option value=""> -- Choisir --</option>
                       @if($tender->getTranslation('type', 'ar')=="وطنية مفتوحة")
                       <option value="وطنية مفتوحة" selected> وطنية مفتوحة </option>
                       ...
                       @endif
                       @if($tender->getTranslation('type', 'ar')=="وطنية محدودة")
                       <option value="وطنية مفتوحة"> وطنية مفتوحة </option>
                       <option value="وطنية محدودة" selected> وطنية محدودة </option>
                       <option value="دولية مفتوحة"> دولية مفتوحة </option>
                       <option value="دولية محدودة"> دولية محدودة </option>
                       @endif
                       @if($tender->getTranslation('type', 'ar')=="دولية مفتوحة")
                       <option value="وطنية مفتوحة"> وطنية مفتوحة </option>
                       <option value="وطنية محدودة" > وطنية محدودة </option>
                       <option value="دولية مفتوحة" selected> دولية مفتوحة </option>
                       <option value="دولية محدودة"> دولية محدودة </option>
                       @endif
                       @if($tender->getTranslation('type', 'ar')=="دولية محدودة")
                       <option value="وطنية مفتوحة"> وطنية مفتوحة </option>
                       <option value="وطنية محدودة" > وطنية محدودة </option>
                       <option value="دولية مفتوحة" > دولية مفتوحة </option>
                       <option value="دولية محدودة" selected> دولية محدودة </option>
                       @endif
             ...
             <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                   <input type="text" class="form-control" name="prix_cahier" placeholder="prix du cahier de charge " value="{{  $tender->prix_cahier }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-9">
                      <div class="custom-file col-sm-9">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="file"  class="@error('file') is-invalid @enderror" value="{{  $tender->doc }}">
